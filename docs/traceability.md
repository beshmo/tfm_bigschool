...
| -------------------------- | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `okvns-domain`             | 9         | `packages/domain/src/{namespace,entry,resource-name,errors}.test.ts`, `packages/shared/src/index.test.ts`                                                                                                                                          |
| `namespace-management`     | 24        | `packages/application/src/{namespace-use-cases,list-query}.test.ts`, `apps/api/src/api.contract.test.ts`, `e2e/{namespaces,list-controls}.spec.ts`                                                                                                 |
| `entry-management`         | 30        | `packages/application/src/{entry-use-cases,list-query}.test.ts`, `apps/api/src/api.contract.test.ts`, `e2e/{entries,list-controls}.spec.ts`                                                                                                        |
| `markdown-bulk-operations` | 19        | `packages/yaml/src/yaml.test.ts` (key allowlists, shapes, duplicates), `packages/application/src/yaml-use-cases.test.ts` (atomic import, upsert), `apps/api/src/api.contract.test.ts`, `e2e/{import,export}.spec.ts`                               |
...
| `api-documentation`        | 12        | `apps/api/src/api.contract.test.ts` (OpenAPI document, Swagger UI, documented query allowlists); the Markdown scenarios are checked by review of `docs/api-and-yaml.md`                                                                            |
...
| `admin-frontend`           | 41        | `apps/admin-web/src/{App,api/okvns-api,design-tokens,pages/*}.test.tsx`, `e2e/*.spec.ts`; the UI structure inventory is verified by the page tests and review                                                                                      |
| `okvns-wrapper-library`    | 14        | `packages/okvns-wrapper/src/wrapper.test.ts`                                                                                                                                                                                                       |
