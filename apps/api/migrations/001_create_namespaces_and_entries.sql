-- Initial schema: namespaces and their entries (utf8mb4_bin: case- and
-- accent-sensitive name uniqueness enforced by the database itself).
...
CREATE TABLE IF NOT EXISTS entries (
  ...
  CONSTRAINT fk_entries_namespace FOREIGN KEY (namespace_id)
