...
Entry CRUD operations scoped to a namespace, exposed through the REST API and admin frontend. Covers creation, listing, retrieval, update, description updates, environment-dependence metadata, and deletion with validated inputs and safe error responses.
