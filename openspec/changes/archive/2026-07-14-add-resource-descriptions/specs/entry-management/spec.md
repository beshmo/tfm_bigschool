...
- **WHEN** a client submits a valid entry name, value, and optional valid description for an existing namespace
...
The system SHALL allow API clients and admin users to list entries for a namespace, including entry description and timestamp metadata.
...
The system SHALL allow API clients and admin users to retrieve an entry by namespace name and entry name, including entry description and timestamp metadata.
...
The system SHALL allow API clients and admin users to update an entry name, value, description, or any combination within an existing namespace, committing the update to durable storage and updating entry modification metadata.
