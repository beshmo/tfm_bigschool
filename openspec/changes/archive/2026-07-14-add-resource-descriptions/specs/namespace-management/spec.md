...
The system SHALL allow API clients and admin users to list all namespaces currently stored in durable storage, including namespace description and timestamp metadata.
...
- **AND** each namespace includes `description` when one is stored
